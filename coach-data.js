(() => {
  ...
  const protocols = [
    ...
    { id: "wim_hof", title: "Wim Hof breathing", grade: "C", tag: "Experimental", dose: "30 nhịp · tối đa 3 rounds", summary: "Không có claim giảm mỡ hay tăng miễn dịch. Chỉ dành cho người lớn khỏe mạnh đã đọc safety gate.", steps: ["Chỉ ngồi hoặc nằm ở nơi an toàn.", "Thở 30 nhịp không gắng sức.", "Giữ sau thở ra đến khi cơ thể tự muốn thở; recovery breath 10–15 giây.", "Tối đa 3 rounds; không thi thời gian nín thở."], safety: "Có thể gây choáng hoặc mất ý thức. Không bao giờ tập trong/gần nước, dưới vòi sen, khi lái xe, đứng, hoặc vận hành máy móc. Không thực hiện nếu mang thai, epilepsy hoặc có bệnh tim mạch nghiêm trọng nếu chưa được bác sĩ cho phép.", sourceLabel: "Wim Hof Method safety FAQ", source: "https://www.wimhofmethod.com/faq", requiresSafetyAck: true },
